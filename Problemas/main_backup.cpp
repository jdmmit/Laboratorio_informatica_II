...
void problema16()
{
    ...
    cout << "El elemento inicial j (semilla) menor que k que produce la serie mas larga es: " << best_seed << endl;
    cout << "La cantidad de terminos m en la serie es: " << max_length << endl;
